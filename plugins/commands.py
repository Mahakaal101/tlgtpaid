...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('⚡ UᎮDΛTΞS ⚡', url='https://t.me/film_update_official')
            ],
            [
                InlineKeyboardButton('⚡ FOLLOW ⚡', url=f"https://t.me/shortnfly"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ FOLLOW ⚡', url='https://t.me/shortnfly'),
            InlineKeyboardButton('🤖 UᎮDΛTΞS 🤖', url='https://t.me/film_update_official')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('LATEST MOVIES HERE', url='https://t.me/+WOrSTTigB7s5YjY1') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
